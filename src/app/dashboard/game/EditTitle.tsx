...
import { TitleItemData } from "./Titles"
...
export function EditTitleDialog({ onSave, data }: Props) {
  ...
  const handleSave = async () => {
    try {
     ...
     const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/title/edit`, {
        id: data.id,
        name: title,
        index: index,
